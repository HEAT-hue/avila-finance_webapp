        ...
        <div className="py-3 px-4 bg-[#ffffff]">
            ...
            <div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-x-5">
                    <button className="flex py-3 pl-4 gap-x-3 rounded-md border-[1px] border-[#349234a9] shadow-sm text-[#175e17da]"> <span><AddSVG size={18} /></span> <span className="font-mono font-bold">Add money</span></button>
